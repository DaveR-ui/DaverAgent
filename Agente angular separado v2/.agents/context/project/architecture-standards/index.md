...
- Existing docs under `.agents/context/` remain the detailed source of truth.
...
- Coding defaults: [coding-conventions.md](../../standards/coding-conventions.md)
- Guardrails and anti-patterns: [rules.md](../rules.md)
