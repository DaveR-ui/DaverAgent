...
description: Core architecture principles, state management, and data flow standards for the Angular application.
tags: [angular, architecture, signals, change-detection]
status: active
---
