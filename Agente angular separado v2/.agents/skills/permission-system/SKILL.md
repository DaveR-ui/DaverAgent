...
1. **Lectura del Documento Base:**
   El agente DEBE seguir estrictamente la arquitectura definida en `.agents/context/permissions/permissionArch.md`.
...
**Nota:** Cualquier cambio que afecte esta arquitectura debe reflejarse en `.agents/context/permissions/permissionArch.md` como fuente de verdad.
