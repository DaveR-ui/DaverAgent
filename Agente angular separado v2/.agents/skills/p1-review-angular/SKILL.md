...
2. **Key Focus Areas**:
   ...
   - **Package-Specific Guidelines**: Check if there are specific guidelines for the package being modified in the `references/` directory (e.g., `references/router.md`). Always prioritize these rules for their respective packages.
...
```bash
.agents/skills/p1-review-angular/scripts/determine_review_type.sh <PR_NUMBER>
```
...
```bash
.agents/skills/p1-review-angular/scripts/get_pr_comments.sh <PR_NUMBER>
```
...
```bash
.agents/skills/p1-review-angular/scripts/reply_pr_comment.sh <PR_NUMBER> <COMMENT_ID> <REPLY_BODY>
```
...
```bash
.agents/skills/p1-review-angular/scripts/post_inline_comment.sh <PR_NUMBER> <FILE_PATH> <LINE_NUMBER> <COMMENT_BODY>
```

**Example:**

```bash
.agents/skills/p1-review-angular/scripts/post_inline_comment.sh 12345 "packages/core/src/render3/instructions/element.ts" 42 "AGENT: Consider the performance implications here."
```
...
```bash
.agents/skills/p1-review-angular/scripts/submit_pr_review.sh <PR_NUMBER> <EVENT_TYPE> [BODY]
```
...
```bash
.agents/skills/p1-review-angular/scripts/submit_pr_review.sh 12345 COMMENT "AGENT: I have left a few inline suggestions for your consideration."
```
