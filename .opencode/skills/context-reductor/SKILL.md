...
| **Known Pattern Match** | Matches a hot spot pattern from the dictionary | Flag with risk notes |
...
```
Raw Prompt → prompt-analyzer → Structured Analysis → context-reductor → Scope + Complexity + Hot Spots + Hidden Assumption → Resolution
```
