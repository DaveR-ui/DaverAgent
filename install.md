...
`docs/tag-index.md`, and the project slang snapshot, then installs the derived
validator at `docs/validate.js`
...
| `docs/context/project-slang.md` | Project slang snapshot generated by the docs bootstrap (edit the rows) |
