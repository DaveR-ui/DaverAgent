...
This document describes the architecture of the `goland-api` project. It is intended to guide agents and developers in understanding the system structure and ensuring infrastructure integrity. For environment or runtime issues, consult [docker-strategy.md](./docker-strategy.md).
