...
Use this template to generate agents with your preferred strong model and then assign the final agent model explicitly by task type.
...
### Step 3: The Generator Returns JSON
...
model: [choose: gpt-5.4 for strong general/review, gpt-5.3-codex for coding, gemini-flash for quick docs/read-only]
...
**You create:** `agents/test-generator.md` with `model: gpt-5.3-codex` because test generation is a code-writing task.
