...
- See `.github/agent-context/github-pr-fetch.md` for the exact commands to fetch the file list and diff.
...
- **For New Components**: Read and strictly apply the rules found in `.github/skills/gitkraken-pr-analysis/references/rules-new-component.md`.
- **For Old Components / Bug fixes**: Read and strictly apply the rules found in `.github/skills/gitkraken-pr-analysis/references/rules-bug-fix.md`.
