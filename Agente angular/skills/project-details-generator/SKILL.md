...
*   **Key Paths**: Map the location of the context hub (`.github/agent-context/`) and the agents directory.
...
#### C. Operational Paths
*   **Context Hub**: `.github/agent-context/`
*   **Skills Index**: `.github/skills/SKILLS_INDEX.md`
*   **Routing Reference**: `.github/agent-workflows/orchestrate.md`
