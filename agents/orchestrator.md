...
- **Escalation ladder** — `minimax-m3` → `kimi-k2.7-code` → `glm-5.2` → `kimi-k3`. Do not escalate by default; only when the task demands it.
...
| `reviewer` | `minimax-m3` | Code review, security, performance | `ReviewerOutput` |
